...
//            }
    ...
    private static void setRowValue(Cell cell, Object value, SXSSFSheet sheet) {
        ...
        } else if (value instanceof IsActiveEnum) {
            cell.setCellValue(((IsActiveEnum) value).getValue());
        } else if (value instanceof StatusEnum) {
            cell.setCellValue(((StatusEnum) value).getValue());
        } else if (value instanceof IsDisplayEnum) {
            cell.setCellValue(((IsDisplayEnum) value).getValue());
        } else {
