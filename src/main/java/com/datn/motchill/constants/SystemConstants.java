package com.datn.motchill.constants;
...
public final class SystemConstants {
	...
	public static final int MOVIE_COMING_OUT = 1;
	public static final int MOVIE_OF_MONTH = 2;
	public static final int MOVIE_MOST_WATCHED = 3;
